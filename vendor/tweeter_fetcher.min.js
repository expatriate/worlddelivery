...
(function(root, factory) {
  ...
  function handleTweets(tweets) {
    if (customCallbackFunction === null) {
      ...
      while (n < x) {
        html += "<div class='swiper-slide news-slide'>" + tweets[n] + "</div>";
        n++;
      }
      html += "</div>";
      element.innerHTML = html;
      var event = new CustomEvent("twitterparsed", {});
      document.getElementById('section-news__slider').dispatchEvent(event);
    } else {
  ...
  function extractImagesUrl(image_data) {
    if (
      ...
      var data_src = image_data.innerHTML.match(
        /data-image=\"([A-z0-9]+:\/\/[A-z0-9]+\.[A-z0-9]+\.[A-z0-9]+\/[A-z0-9]+\/[A-z0-9\-]+)\"/gi
      );
      for (var i = 0; i < data_src.length; i++) {
        data_src[i] = data_src[i].match(
      ...
      if (dataOnly) {
        ...
        while (n < x) {
          ...
          if (parseLinks) {
            ...
            if (printUser) {
              op +=
                '<div class="news-slide__user__wrapper"><div class="news-slide__user">' + 
                  strip(authors[n].innerHTML) + 
                  '<div class="news-slide__timePosted">' +
            ...
            /*if (printTime) {
              if (permalinks) {
                op +=
                  '<div class="news-slide__timePosted"><a href="' +
                  permalinksURL[n] +
                  '">' +
                  times[n].getAttribute("aria-label") +
                  "</a></div>";
            ...
            if (
              ...
              for (var i = 0; i < extractedImages.length; i++) {
                op +=
                  '<div class="news-slide__media__wrapper"><div class="news-slide__media">' +
                  '<img src="' +
                  extractedImages[i] +
            ...
            op += '<div class="news-slide__tweet__wrapper"><div class="news-slide__tweet">' + strip(tweets[n].innerHTML) + "</div></div>";
          } else {
            if (tweets[n].textContent) {
              if (printUser) {
                op += '<div class="news-slide__user">' + authors[n].textContent + "</div>";
              }
              op += '<div class="news-slide__tweet">' + tweets[n].textContent + "</div>";
              if (printTime) {
                op += '<div class="news-slide__timePosted">' + times[n].textContent + "</div>";
              }
            } else {
              if (printUser) {
                op += '<div class="news-slide__user">' + authors[n].textContent + "</div>";
          ...
          if (showInteractionLinks) {
            op +=
              '<div class="interact"><a href="https://twitter.com/intent/' +
              "tweet?in_reply_to=" +
              tids[n] +
